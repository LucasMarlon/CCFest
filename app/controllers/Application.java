...
public class Application extends Controller {
	...
	private static final int DATA_SETE = 7, DATA_TRES = 3, DATA_DOZE = 12,
			DATA_DEZESSETE = 17, DATA_CINCO = 5, DATA_QUINZE = 15,
			DATA_VINTE_UM = 21, DATA_OITO = 8, TRES = 3;
	...
	private static void criarParticipacoesFake(List<Evento> eventos) {
		...
		try {
			criarParticipacao(new Participante("Alberto Leça",
					"alberto_leca@mail.com", eventos.get(rnd.nextInt(TRES))));
			criarParticipacao(new Participante("Alberto Leça",
					"alberto_leca@mail.com", eventos.get(rnd.nextInt(TRES))));
			criarParticipacao(new Participante("Alberto Leça",
					"alberto_leca@mail.com", eventos.get(rnd.nextInt(TRES))));
			criarParticipacao(new Participante("Belmifer Linares",
					"belmifer_linares@mail.com", eventos.get(rnd.nextInt(TRES))));
			criarParticipacao(new Participante("Belmifer Linares",
					"belmifer_linares@mail.com", eventos.get(rnd.nextInt(TRES))));
			criarParticipacao(new Participante("Célia Rúa",
					"celia_rua@mail.com", eventos.get(rnd.nextInt(TRES))));
			...
			criarParticipacao(new Participante("Doroteia Pasos",
					"doroteia_passos@mail.com", eventos.get(rnd.nextInt(TRES))));
			criarParticipacao(new Participante("Eugénio Palhares",
					"eugenio_palhares@mail.com", eventos.get(rnd.nextInt(TRES))));
			criarParticipacao(new Participante("Fausto Furtado",
					"fausto_furtado@mail.com", eventos.get(rnd.nextInt(TRES))));
			criarParticipacao(new Participante("Filipa Leiria",
					"filipa_leiria@mail.com", eventos.get(rnd.nextInt(TRES))));
			criarParticipacao(new Participante("Leonilde Figueiredo",
					"leonilde_figueiredo@mail.com", eventos.get(rnd
							.nextInt(TRES))));
			criarParticipacao(new Participante("Pascoal Caldeira",
					"pascoal_caldeira@mail.com", eventos.get(rnd.nextInt(TRES))));
			criarParticipacao(new Participante("Paula Lousado",
					"paula_lousado@mail.com", eventos.get(rnd.nextInt(TRES))));
			criarParticipacao(new Participante("Quitério Galindo",
					"quiterio_galindo@mail.com", eventos.get(rnd.nextInt(TRES))));
			criarParticipacao(new Participante("Rosa Varejão",
					"rosa_varejao@mail.com", eventos.get(rnd.nextInt(TRES))));
			criarParticipacao(new Participante("Sonia Gabeira",
					"sonia_gabeira@mail.com", eventos.get(rnd.nextInt(TRES))));
